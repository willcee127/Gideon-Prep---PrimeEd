        ...
        >
          ...
          >
            <div className="inline-block">
              ...
              >
                <div className="bg-gradient-to-r from-purple-600 to-blue-500 text-white px-6 py-3 rounded-full shadow-2xl border-2 border-white/30 backdrop-blur-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="mb-6">
                ...
                <AuraPowerBar value={powerBarWidth} />
              </div>
            </motion.div>
