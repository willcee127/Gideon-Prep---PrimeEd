...
const WelcomeBriefing = ({ onComplete }) => {
  const [isVisible, setIsVisible] = useState(false)

  // Check if user has seen briefing
  useEffect(() => {
    const hasSeenBriefing = localStorage.getItem('gideon_welcome_briefing_seen')
    if (!hasSeenBriefing) {
      setIsVisible(true)
    }
  }, [])
  ...
  const handleDismiss = () => {
    localStorage.setItem('gideon_welcome_briefing_seen', 'true')
    setIsVisible(false)
    if (onComplete) {
      onComplete()
    }
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-white text-sm">Use Command Calc to handle the math</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-white text-sm">Tap Coach if you need Intel</p>
                    </div>
                  </div>
                </div>
